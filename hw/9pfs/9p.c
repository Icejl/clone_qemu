                               ...
                               Error **errp)
{
	...
	// local模式的ops = local_ops
    s->ops = fse->ops;

	// 设置文件权限，只有在security=mapping-xx时才支持
	...
	// 根据安全模型设置xops，local模式 = none_xattr_ops
